  ...
  const orders: Order[] = [
    {
      ...
      date: '٢٦ أبريل، ٢٠٢٥',
      items: [
        { id: 1, name: 'بيج ماك', quantity: 2, price: 45 },
        { id: 2, name: 'بطاطس كبير', quantity: 1, price: 18 },
        { id: 3, name: 'كوكا كولا', quantity: 2, price: 12 },
      ],
      total: 132,
      deliveryFee: 15,
    ...
    },
    {
      ...
      date: '٢ مايو، ٢٠٢٥',
      items: [
        { id: 1, name: 'واپر', quantity: 1, price: 60 },
        { id: 2, name: 'اونيون رينجز', quantity: 1, price: 25 },
      ],
      total: 100,
      deliveryFee: 15,
    ...
    },
    {
      ...
      date: '٢ مايو، ٢٠٢٥',
      items: [
        { id: 1, name: 'بيتزا سوبريم كبيرة', quantity: 1, price: 120 },
        { id: 2, name: 'كوكا كولا عائلي', quantity: 1, price: 25 },
        { id: 3, name: 'خبز بالثوم', quantity: 2, price: 30 },
      ],
      total: 205,
      deliveryFee: 0,
    ...
    },
    {
      ...
      date: '١ مايو، ٢٠٢٥',
      items: [
        { id: 1, name: 'وجبة دجاج عائلية', quantity: 1, price: 160 },
      ],
      total: 175,
      deliveryFee: 15,
    ...
    },
    {
      ...
      date: '٣٠ أبريل، ٢٠٢٥',
      items: [
        { id: 1, name: 'بيتزا ببروني متوسطة', quantity: 2, price: 90 },
        { id: 2, name: 'كوكا كولا', quantity: 2, price: 12 },
      ],
      total: 204,
      deliveryFee: 12,
