      ...
      <div className="max-w-md mx-auto bg-white pb-24">
        ...
        <div className="p-4">
          ...
          <div className="mb-6">
            ...
            {isAddingNewAddress ? <Card className="border-0 shadow-sm overflow-hidden">
                <CardContent className="p-4">
                  ...
                  <Form {...newAddressForm}>
                    ...
                    field
                            ...
                            <FormControl>
                              <Input {...field} placeholder="مثال: المنزل، العمل، ..." className="border-gray-300 focus:border-purple-400 focus:ring-purple-400" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>} />
                    ...
                    field
                            ...
                            <FormControl>
                              <Input {...field} type="tel" placeholder="05xxxxxxxx" className="border-gray-300 focus:border-purple-400 focus:ring-purple-400" dir="ltr" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>} />
                    ...
                    field
                            ...
                            <FormControl>
                              <Input {...field} placeholder="مثال: شارع الملك فهد، حي الورود، الرياض" className="border-gray-300 focus:border-purple-400 focus:ring-purple-400" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>} />

                      <div className="pt-2 flex gap-3">
                        <Button type="button" variant="outline" className="flex-1 border-gray-300" onClick={handleCancelAddAddress}>
                          إلغاء
                        </Button>
              ...
              </Card> : <Card className="border-0 shadow-sm overflow-hidden">
                <CardContent className="p-4">
                  <RadioGroup value={selectedAddressId} onValueChange={setSelectedAddressId} className="space-y-3">
                    {addresses.map(address => <div key={address.id} className="relative">
                        ...
                        <Label htmlFor={`address-${address.id}`} className="flex flex-col space-y-1 cursor-pointer rounded-lg border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-purple-500 peer-data-[state=checked]:bg-purple-50">
                          <div className="flex items-start justify-between">
                            ...
                            {selectedAddressId === address.id && <div className="h-4 w-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500"></div>}
                          </div>
                        </Label>
                      </div>)}
                  </RadioGroup>
                  ...
                  <Button variant="outline" onClick={() => setIsAddingNewAddress(true)} className="w-full mt-3 flex justify-center items-center gap-2 border-dashed border-gray-300 h-14 hover:border-purple-400 hover:bg-purple-50">
              ...
              <CardContent className="p-4">
                <RadioGroup value={selectedPayment} onValueChange={value => setSelectedPayment(value as PaymentMethod)} className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <Label htmlFor="payment-cash" className="flex flex-col space-y-1 cursor-pointer rounded-lg border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-purple-500 peer-data-[state=checked]:bg-purple-50">
                      <div className="flex items-center justify-between">
                        ...
                        {selectedPayment === 'cash' && <div className="h-4 w-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500"></div>}
                      </div>
                    </Label>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <Label htmlFor="payment-card" className="flex flex-col space-y-1 cursor-pointer rounded-lg border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-purple-500 peer-data-[state=checked]:bg-purple-50">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="rounded-full border border-gray-200 p-1.5 bg-white">
                        ...
                        {selectedPayment === 'card' && <div className="h-4 w-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500"></div>}
                      </div>
                    </Label>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <Label htmlFor="payment-wallet" className="flex flex-col space-y-1 cursor-pointer rounded-lg border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-purple-500 peer-data-[state=checked]:bg-purple-50">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="rounded-full border border-gray-200 p-1.5 bg-white">
                        ...
                        {selectedPayment === 'wallet' && <div className="h-4 w-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500"></div>}
                      </div>
                    </Label>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <Label htmlFor="payment-applepay" className="flex flex-col space-y-1 cursor-pointer rounded-lg border border-gray-200 p-4 hover:bg-gray-50 peer-data-[state=checked]:border-purple-500 peer-data-[state=checked]:bg-purple-50">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="rounded-full border border-gray-200 p-1.5 bg-white">
                        ...
                        {selectedPayment === 'applepay' && <div className="h-4 w-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500"></div>}
                      </div>
                    </Label>
                  </div>
                </RadioGroup>
                ...
                {selectedPayment === 'card' && <div className="flex items-center justify-between px-2 py-3 mt-3 bg-gray-50 rounded-lg">
                ...
                {/* Card Details Form */}
                {selectedPayment === 'card' && <div className="mt-4 space-y-4 border-t pt-4">
                    <div className="space-y-2">
                      <Label htmlFor="card-number">رقم البطاقة</Label>
                      <Input id="card-number" placeholder="XXXX XXXX XXXX XXXX" className="border-gray-300 focus:border-purple-400 focus:ring-purple-400" />
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-2">
                        <Label htmlFor="expiry-date">تاريخ الانتهاء</Label>
                        <Input id="expiry-date" placeholder="MM/YY" className="border-gray-300 focus:border-purple-400 focus:ring-purple-400" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="cvv">CVV</Label>
                        <Input id="cvv" placeholder="XXX" className="border-gray-300 focus:border-purple-400 focus:ring-purple-400" />
                      </div>
                    </div>
                    <div className="flex items-center">
                      <input type="checkbox" id="save-card" checked={saveCardInfo} onChange={() => setSaveCardInfo(!saveCardInfo)} className="w-4 h-4 text-purple-600 rounded border-gray-300 focus:ring-purple-500" />
