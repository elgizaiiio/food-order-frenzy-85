...
const Restaurants: React.FC = () => {
  ...
  const foodCategories = [
    { id: 1, name: "حلويات", color: "bg-pink-500 text-white" },
    { id: 2, name: "شاورما", color: "bg-amber-500 text-white" },
    { id: 3, name: "برجر", color: "bg-red-500 text-white" },
    { id: 4, name: "ساندوتشات", color: "bg-green-500 text-white" },
    { id: 5, name: "بيتزا", color: "bg-blue-500 text-white" },
    { id: 6, name: "كافيه", color: "bg-purple-500 text-white" },
    { id: 7, name: "دجاج", color: "bg-orange-500 text-white" },
    { id: 8, name: "عصائر", color: "bg-cyan-500 text-white" },
    { id: 9, name: "كريب", color: "bg-indigo-500 text-white" },
    { id: 10, name: "دجاج مقلي", color: "bg-lime-500 text-white" },
    { id: 11, name: "إفطار", color: "bg-yellow-500 text-black" },
    { id: 12, name: "أخرى", color: "bg-gray-500 text-white" }
  ];
          ...
          <div className="flex items-center gap-2 p-4 bg-gray-50">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="link" className="h-auto p-0 flex items-center gap-1 text-sm">
        ...
        <div className="px-4 py-3 border-b">
          <div className="flex overflow-x-auto gap-4 pb-3 no-scrollbar">
            {foodCategories.map(category => (
              ...
              >
                <div 
                  className={`px-4 py-2 rounded-lg ${category.color} transition-colors ${
                    activeFilterCategory === category.id ? 'ring-2 ring-primary ring-offset-2' : ''
                  }`}
                >
        ...
        <div className="px-4 py-3 flex gap-2 overflow-x-auto no-scrollbar border-b">
          {filters.map(filter => (
            <Button 
              ...
              size="sm"
              className={`rounded-full whitespace-nowrap ${activeSortFilter === filter.id ? 'bg-primary' : ''}`}
