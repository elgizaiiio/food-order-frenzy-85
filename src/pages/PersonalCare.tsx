...
const PersonalCare: React.FC = () => {
  ...
  const womenCategories = [{
    id: 'makeup',
    name: 'الميكب',
    image: 'https://images.unsplash.com/photo-1631214540553-ff044a3ff1d4?q=80&w=300&auto=format&fit=crop'
  }, {
    id: 'skincare',
    name: 'سكين كير',
    image: 'https://images.unsplash.com/photo-1570194065650-d99fb4ee271b?q=80&w=300&auto=format&fit=crop'
  }, {
    id: 'accessories',
    name: 'اكسسوارات',
    image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?q=80&w=300&auto=format&fit=crop'
  }, {
    id: 'perfumes',
    name: 'عطور',
    ...
    id: 'nailcare',
    name: 'نيل كير',
    image: 'https://images.unsplash.com/photo-1631213177572-fd7818a37d85?q=80&w=300&auto=format&fit=crop'
  }];
  ...
  const menCategories = [{
    id: 'menperfumes',
    name: 'عطور',
    image: 'https://images.unsplash.com/photo-1600612253971-422e7f7faeb6?q=80&w=300&auto=format&fit=crop'
  }, {
    id: 'menaccessories',
    name: 'اكسسوارات',
    image: 'https://images.unsplash.com/photo-1527719327859-c6ce80353573?q=80&w=300&auto=format&fit=crop'
  }, {
    id: 'shaving',
    name: 'الحلاقة والعناية باللحية',
    image: 'https://images.unsplash.com/photo-1621607514922-i9eba47788c5?q=80&w=300&auto=format&fit=crop'
  }, {
    id: 'menskincare',
    name: 'سكين كير رجالي',
    image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?q=80&w=300&auto=format&fit=crop'
  }, {
    id: 'deodorants',
    name: 'ديودرنت',
    image: 'https://images.unsplash.com/photo-1626818590338-bed90abab6fe?q=80&w=300&auto=format&fit=crop'
  }];
  ...
  const featuredProducts = [{
    ...
    name: 'أحمر شفاه',
    price: 75,
    image: 'https://images.unsplash.com/photo-1599733589518-2c5ee3b25b10?q=80&w=200&auto=format&fit=crop'
  }];

  // Suggested products
  const suggestedProducts = [{
    id: 5,
    name: 'عطر فرنسي رجالي',
    price: 350,
    ...
    name: 'مقشر للجسم',
    price: 120,
    image: 'https://images.unsplash.com/photo-1631730359585-5e3085eb4d5b?q=80&w=200&auto=format&fit=crop'
  }, {
    id: 7,
    name: 'كريم يدين',
    price: 45,
  ...
  return <div className="min-h-screen bg-blue-50" dir="rtl">
      <div className="max-w-md mx-auto bg-white pb-20">
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          <img src="https://images.unsplash.com/photo-1612817288484-6f916006741a?q=80&w=600&auto=format&fit=crop" alt="Personal Care Banner" className="w-full h-full object-cover" />
        ...
        <div className="p-4">
          <div className="relative">
            <input type="text" placeholder="ابحث عن منتجات العناية الشخصية..." className="w-full p-3 pr-10 rounded-full border border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {womenCategories.map(category => <Link key={category.id} to={`/personal-care/category/${category.id}`}>
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {menCategories.map(category => <Link key={category.id} to={`/personal-care/category/${category.id}`}>
                <div className="relative rounded-lg overflow-hidden h-32 shadow-md hover:shadow-lg transition-shadow">
                  <img src={category.image} alt={category.name} className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent flex items-end p-3">
                    <h3 className="text-white font-bold">{category.name}</h3>
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {featuredProducts.map(product => <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow border border-blue-100">
                ...
                <div className="p-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Button size="sm" className="rounded-full h-7 w-7 p-0 bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800" onClick={() => handleAddToCart(product)}>
                      +
                    </Button>
                  </div>
                </div>
        ...
        <div className="px-4 mb-8">
          ...
          <div className="flex overflow-x-auto gap-4 pb-4 no-scrollbar">
            {suggestedProducts.map(product => <Card key={product.id} className="min-w-[160px] overflow-hidden hover:shadow-lg transition-shadow border border-blue-100">
                <Link to={`/personal-care/product/${product.id}`}>
                ...
                <div className="p-3">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <Button size="sm" className="rounded-full h-6 w-6 p-0 bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800" onClick={() => handleAddToCart(product)}>
                      +
                    </Button>
                  </div>
                </div>
