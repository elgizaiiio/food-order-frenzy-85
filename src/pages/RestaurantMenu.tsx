    ...
    <div className="min-h-screen bg-slate-50" dir="rtl">
      <div className="max-w-md mx-auto bg-white pb-24">
        ...
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-blue-900/75 to-blue-900/10">
        ...
        <div className="relative px-4 pb-4 border-b">
          <div className="flex items-start mt-3">
            ...
            <div className="ml-3 pt-1">
              <h1 className="text-2xl font-bold text-blue-900">{restaurant.name}</h1>
        ...
        <div className="px-4 py-3">
          {categoryHasItems ? (
            filteredItems.map(item => (
              <div 
                key={item.id} 
                className="flex gap-3 border-b py-4 group hover:bg-blue-50/50 transition-colors rounded-lg px-2"
              >
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <Button 
                      ...
                      className="rounded-full shadow-sm bg-gradient-to-r from-blue-600 to-sky-500 hover:from-blue-700 hover:to-sky-600 group-hover:scale-105 transition-all"
                    >
                ...
                <div className="relative w-28 h-28 flex-shrink-0">
                  ...
                  />
                  {item.offer && (
                    <Badge className="absolute top-2 right-2 text-xs bg-gradient-to-r from-blue-600 to-sky-500 shadow-sm border-0">
                      {item.offer}
                    </Badge>
                  )}
                </div>
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <h3 className="text-lg font-bold text-blue-900 mb-2">هذا القسم فارغ حاليًا</h3>
        ...
        {cartItems.length > 0 ? (
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-4 max-w-md mx-auto shadow-lg animate-fade-in my-[56px]">
            <Button 
              onClick={() => navigate('/cart')} 
              className="w-full py-6 text-lg rounded-xl bg-gradient-to-r from-blue-600 to-sky-500 hover:from-blue-700 hover:to-sky-600 text-white shadow-md hover:shadow-lg transition-shadow"
            >
