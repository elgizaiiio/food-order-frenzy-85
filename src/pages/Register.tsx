...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-500 via-brand-400 to-yellow-400 flex flex-col items-center justify-center p-4" dir="rtl" style={{
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-block w-24 h-24 rounded-2xl bg-blue-800 text-brand-600 flex items-center justify-center mb-5 shadow-xl animate-bounce-in transform -rotate-12">
          ...
          <CardContent className="pt-6 px-6 pb-8">
            ...
            <div className="text-center mt-6">
              <p className="text-gray-600">
                لديك حساب بالفعل؟{" "}
                <Link to="/login" className="text-brand-600 hover:text-brand-700 font-bold">تسجيل الدخول</Link>
              </p>
            </div>
          </CardContent>
        </Card>
