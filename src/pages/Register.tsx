...
const Register: React.FC = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-brand-500 via-brand-400 to-yellow-400 flex flex-col items-center justify-center p-4" dir="rtl" style={{
    ...
    paddingRight: 'env(safe-area-inset-right, 0px)'
      ...
      <div className="w-full max-w-md bg-sky-300">
        <div className="text-center mb-8 bg-sky-300">
          <div className="inline-block w-24 h-24 rounded-2xl text-brand-600 flex items-center justify-center mb-5 shadow-xl animate-bounce-in transform -rotate-12 bg-blue-800">
            <span className="text-3xl font-bold text-neutral-50">دام</span>
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">إنشاء حساب جديد</h1>
          <p className="text-white/90 text-lg font-extrabold">انضم إلينا واستمتع بتجربتنا المميزة</p>
        </div>
        
        <Card className="border-none shadow-2xl bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden animate-fade-in">
          <div className="h-2 bg-gradient-to-r from-brand-600 to-brand-400 bg-sky-900"></div>
          <CardContent className="pt-6 px-6 pb-8">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                field
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input placeholder="أدخل اسمك الكامل" className="pl-10 h-12 bg-gray-50 border-gray-200 rounded-xl focus:border-brand-500 focus:ring-brand-500" {...field} />
                ...
                field
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input placeholder="أدخل بريدك الإلكتروني" className="pl-10 h-12 bg-gray-50 border-gray-200 rounded-xl focus:border-brand-500 focus:ring-brand-500" {...field} />
                ...
                field
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input type={showPassword ? "text" : "password"} placeholder="أدخل كلمة المرور" className="pl-10 h-12 bg-gray-50 border-gray-200 rounded-xl focus:border-brand-500 focus:ring-brand-500" {...field} />
                ...
                field
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input type={showConfirmPassword ? "text" : "password"} placeholder="أكد كلمة المرور" className="pl-10 h-12 bg-gray-50 border-gray-200 rounded-xl focus:border-brand-500 focus:ring-brand-500" {...field} />
                ...
                <Button type="submit" variant="gradient" size="lg" className="w-full h-14 rounded-xl font-bold shadow-lg transition-all hover:shadow-xl mt-4" disabled={loading.email}>
            ...
            <div className="text-center mt-6">
              <p className="text-gray-600">
                لديك حساب بالفعل؟{" "}
                <Link to="/login" className="text-brand-600 hover:text-brand-700 font-bold">عندي حساب اصلا </Link>
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button variant="outline" className="h-12 border-white/30 bg-white/80 hover:bg-white text-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all" onClick={handleGoogleLogin} disabled={loading.google}>
          ...
          <Button variant="outline" className="h-12 border-white/30 bg-white/80 hover:bg-white text-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all" onClick={handleAppleLogin} disabled={loading.apple}>
