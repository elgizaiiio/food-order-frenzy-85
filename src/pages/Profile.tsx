  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      <div className="max-w-md mx-auto bg-white pb-20">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/edit-profile" className="text-brand-500">
                      <Edit className="w-5 h-5" />
                    </Link>
                  </div>
                  <p className="text-gray-500 text-sm">{user.username}</p>
                  <div className="mt-2 flex items-center">
                    <span className="text-sm text-brand-700">النقاط: {user.points}</span>
        ...
        <div className="px-4 py-6">
          <Card className="overflow-hidden border-none shadow-sm bg-gradient-to-r from-brand-50 to-orange-50">
            <CardContent className="p-5">
              ...
              <Button variant="outline" className="bg-white border-brand-200 hover:bg-gray-50 text-brand-700">
                مشاركة الرمز
              </Button>
            </CardContent>
          </Card>
