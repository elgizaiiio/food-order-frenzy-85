      ...
      <div className="max-w-md mx-auto bg-white pb-20">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-blue-500 to-indigo-600 z-10 shadow-md rounded-b-2xl">
          ...
          <div className="px-4 pb-6">
            ...
            <Button 
              variant="outline" 
              className="w-full mt-3 flex items-center justify-between border-white text-white hover:bg-white/20 backdrop-blur-sm" 
            ...
            {categoriesLoading ? (
              ...
              <div className="grid grid-cols-4 gap-3">
                {categories?.map(category => (
                  <Link key={category.id} to={`/pharmacy/category/${category.id}`} className="flex flex-col items-center">
