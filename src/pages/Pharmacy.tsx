...
const PharmacyContent: React.FC = () => {
  ...
  const { data: categories, isLoading: categoriesLoading } = usePharmacyCategories();
  const { data: products, isLoading: productsLoading } = usePharmacyCategoryProducts(activeCategory);
  const { addToCart, itemCount, totalPrice } = usePharmacyCart();
      ...
      <div className="max-w-md mx-auto bg-white">
        ...
        <div className="mb-4">
          <div className="overflow-x-auto no-scrollbar">
            <div className="inline-flex gap-3 px-4 pb-2" style={{ minWidth: '100%' }}>
              {categoriesLoading ? (
          ...
          {productsLoading ? (
            ...
            <div className="grid grid-cols-2 gap-4">
              {products?.map((product) => (
                <Card key={product.id} className="overflow-hidden shadow-sm hover:shadow-md transition-all rounded-xl">
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button 
                        ...
                        size="sm" 
                        className={`rounded-full h-8 w-8 p-0 ${product.inStock ? 'bg-brand-500 hover:bg-brand-600' : 'bg-gray-300'}`}
                      >
        ...
        {itemCount > 0 && (
          <Link to="/pharmacy/cart">
            <div className="fixed bottom-5 left-0 right-0 mx-auto w-4/5 max-w-md bg-brand-500 text-white rounded-full py-3 px-5 flex items-center justify-between shadow-lg animate-fade-in">
