...
const Header: React.FC = () => {
  ...
  return <div className="px-4 pt-6 pb-2 animate-fade-in">
      {/* Delivery Address */}
      ...
      <div className="relative mb-6">
        <Input type="search" placeholder="دور على المطاعم والي انت عايزه" className="w-full py-6 pl-4 pr-10 rounded-full bg-gray-50 border-none shadow-sm text-right" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} />
