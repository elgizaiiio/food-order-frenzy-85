  ...
  return (
    <div className="px-4 mb-8 animate-fade-in animate-delay-2">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link to="/offers" className="text-brand-500 text-sm font-medium">عرض الكل</Link>
      </div>
      
      <Carousel className="w-full">
        <CarouselContent className="-ml-2 md:-ml-4">
          {offers.map(offer => (
            <CarouselItem key={offer.id} className="pl-2 md:pl-4 basis-9/10 sm:basis-3/4 lg:basis-1/2">
              <Link to={offer.link}>
